      ...
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-description mt-5">
            Our flexible service tiers offer end‑to‑end support for organizations
            at any stage—from foundational cloud readiness to enterprise‑level
            governance and cybersecurity. Choose the engagement level that fits
            your operational needs, and let us build a secure, scalable future
            together.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6 items-center mt-10 lg:flex-row lg:items-end lg:justify-center">
          {pricingTiers.map(
            (
              ...
              <div
                key={title} /* Or tierIndex if titles could repeat */
                className={twMerge(
                  "card",
              ...
              >
                ...
                <ul className="flex flex-col gap-5 mt-8">
                  {features.map((feature) => (
                    <li
                      key={feature} /* Falls back gracefully; use index if duplicates */
